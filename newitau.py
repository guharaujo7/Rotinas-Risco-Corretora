...
class HistoricoOperacoesData:
    ...
    def _ensure_schema(self):
        ...
        try:
            ...
            # tabela já existente). Adiciona se faltar; ignora se já existir.
            try:
    ...
    def registrar_operacao(self, *, cliente, cnpj_sacado, cnpj_cedente, usuario,
        ...
        payload = {
            ...
            "taxa": taxa, "spread": spread, "arquivo_origem": arquivo_origem,
...
class HistoricoOperacoesFrame(tk.Frame, ThreadSafeUIMixin):
    ...
    def _build_filtros(self):
        ...
        tk.Label(periodo_row, text="  (formato dd/mm/aaaa — deixe em branco "
                                    "para não limitar um dos lados)",
