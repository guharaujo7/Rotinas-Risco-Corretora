...
class BraskemTaxasData:
    ...
    (braskem_taxas.db, na mesma pasta de rede dos demais bancos do app,
    em arquivo isolado, sem misturar com os demais módulos)."""
...
# ─── Utilidades de UI/data reaproveitadas por Ligações ─────────────────────
...
# não interfere em nada do Braskem/Histórico.
